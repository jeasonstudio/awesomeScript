...
(function() {
    $("#content_right").remove(); //右侧栏消失
    $(".head_nums_cont_inner").remove(); //工具栏消失
    $(".f13").remove(); //快照消失
    ...
    if ($("#content_left > div")[$("#content_left > div").length - 1].id === '') {
        $($("#content_left > div")[$("#content_left > div").length - 1]).remove();
    }
    if ($("#content_left > div")[0].id === '') {
        $($("#content_left > div")[0]).remove();
    }
